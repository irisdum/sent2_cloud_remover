...
def sam(im1,im2):
    ...
    for i in im1.shape[0]:
        for j in im1.shape[1]:
            pixel1=im1[i,j,:]
            pixel2=im2[i,j,:]
...
def pixels_sam(pixel1,pixel2):
    ...
    assert pixel1.shape==pixel2.shape, "The two pixels does not have the same dimension pix 1 : {} pix 2 {}".format(pixel1.shape,pixel2.shape)
